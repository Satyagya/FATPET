...
public interface CustomerSegmentationConfigurationService {
  ...
  DataAnalyticsResponse<CustomerSegmentationConfigurationResponse> getConfigByBotRefAndSegment (Long customerId, Long botRef, String segmentName);


  DataAnalyticsResponse<CustomerSegmentationConfiguration> updateConfigByBotRefAndSegment(Long customerId, Long botRef, String segmentName, CustomerSegmentationConfigurationRequest customerSegmentationConfigurationRequest);
}
