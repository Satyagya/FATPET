...
import com.engati.data.analytics.engine.entity.Shopify_Customer;
...
public interface GenerateSegmentsRepository extends JpaRepository<Shopify_Customer, Long> {
