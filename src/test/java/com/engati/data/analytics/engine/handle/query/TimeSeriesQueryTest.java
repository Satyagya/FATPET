...
public class TimeSeriesQueryTest {
  ...
  public void test_timeSeriesQueryTest() {
    ...
    DruidAggregatorMetaInfo druidAggregatorMetaInfo = DruidAggregatorMetaInfo.builder()
        .type(DruidAggregatorType.LONGSUM).aggregatorName("new_users")
        .fieldName("new_users").build();
    TimeSeriesQueryMetaInfo timeSeriesQueryMetaInfo = TimeSeriesQueryMetaInfo.builder()
