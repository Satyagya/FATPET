...
public class QueryConstants {
  ...
  public static String CREATED_AT_WINDOW = "and created_at between from_date and to_date";
  public static String CREATED_AT_LT_BASE = "and created_date < '";
  public static String QUOTE_MARK = "'";
  public static String CREATED_AT_GT_BASE = "and created_at > '";
